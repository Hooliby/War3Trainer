...
namespace War3Trainer
{
        ...
        : EventArgs
    {
        ...
        public NewAddressListEventArgs(
            ...
            : this(parentNodeIndex, caption, address, valueType, 1, null)
        {
        }
        ...
        : IAddressNode
    {
        ...
        public string Description { get { return _AddresInfo.Description; } }
    }
        ...
        public override void CreateChildren()
        {
            ...
            for (int i = 1; i <= 12; i++)
            {
                ...
                CreateAddress(new NewAddressListEventArgs(_nodeIndex,
                    ...
                    AddressListValueType.Integer, 1, "最大限制100"));
                CreateAddress(new NewAddressListEventArgs(_nodeIndex,
                    "玩家" + i.ToString() + " - 当前人口",
        ...
        : TrainerNode, ITrainerNode
    {
        ...
        public override void CreateChildren()
        {
            using (WindowsApi.ProcessMemory mem = new WindowsApi.ProcessMemory(_gameContext.ProcessId))
            {
                ...
                AddressListValueType.Float, 1, "最大522"));
                    }
        ...
        : TrainerNode, ITrainerNode
    {
        ...
        public override void CreateChildren()
        {
            ...
            CreateAddress(new NewAddressListEventArgs(_nodeIndex,
                ...
                AddressListValueType.Float, 1, "数值越小攻击越快，例如0.01"));
            CreateAddress(new NewAddressListEventArgs(_nodeIndex,
                "攻击① - 首次延时",
